...
public class SuperAuctionBannerActivity extends Activity{
    ...
    private void requestBanner(String placement){
        final View adContainer = findViewById(R.id.banner_container_sa);
                ...
                public void onRequestFailed(InlineAd inlineAd, final InlineAd.InlineErrorStatus errorStatus) {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(SuperAuctionBannerActivity.this, "Request Failed Called: " + errorStatus.toString(), Toast.LENGTH_LONG).show();
                        }
                    });
